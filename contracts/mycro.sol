...
contract mycro is ConfigurableToken
{
  string public constant name = "mycro";
  string public constant symbol = "mycro";
  ...
  constructor(address _newOwner) public 
  {
    ...
    owner = _newOwner;
    balances[_newOwner] = balances[_newOwner].add(1000000000 * 1 ether);
  }
}
